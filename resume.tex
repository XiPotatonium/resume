...
\datedsubsection{\textbf{Zhejiang University},  Bachelor}{Sep, 2017 -- Present}
  ...
  GPA 3.90/4.00, Rank 12/154

\section{\faUsers\ Experience}

\datedsubsection{\textbf{Student Research Training Project of ZJU}}{June, 2019 -- Sep, 2020}
\role{participator}{}
\begin{itemize}
  \item Took part in a project called Maestro, which is an implementation of the AlphaGo Zero algorithm in Gomoku.
  \item Implemented Monte-Carlo Tree Search for Gomoku and came up with some optimization ideas.
